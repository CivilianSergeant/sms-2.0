...
<div class="nav notify-row" id="top_menu">
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="{{url('inbox')}}">
                <i class="fa fa-bell-o"></i>
                <span class="badge bg-important">{{{count($inbox)}}}</span>
            </a>
            <ul class="dropdown-menu extended inbox">
                <li>
                    <p class="red"><a href="{{url('inbox')}}">Inbox</a></p>
                </li>
                @if(count($inbox))
                    @foreach($inbox as $ib)
                        <li>
                            <a href="{{{url('inbox/details/'.$ib->discussion_id.'/'.$ib->comment_id)}}}">
                                <!--<span class="photo"><img alt="avatar" src="{{ $theme }}images/avatar-mini.jpg"></span>-->
                                        <span class="subject">
                                            <span class="from">{{{$ib->message}}}</span>
                                            <span class="time">{{{Helpers::dateTimeFormat('j F, Y',$ib->created_at)}}}</span>
                                        </span>
                                        <!--<span class="message">
            ...
            <div class="prog-row side-mini-stat">
                ...
                <div class="side-mini-graph">
                    <div class="p-delivery">
                        <div class="sparkline" data-type="bar" data-resize="true" data-height="30" data-width="90%"
                             data-bar-color="#39b7ab" data-bar-width="5"
...
<li class="widget-collapsible">
    ...
    <ul class="widget-container">
        <li>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="{{ $theme }}images/avatar1.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="{{ $theme }}images/chat-avatar2.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="{{ $theme }}images/avatar1_small.jpg" alt=""></a>
                </div>
                <div class="user-details">
