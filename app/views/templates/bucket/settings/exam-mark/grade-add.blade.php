        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="{{{url('settings/save-grade-settings')}}}" id="gradeFrm" method="post" class="cmxform form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2">
                                <input type="text" class="form-control col-lg-2" id="mark" name="mark"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2">
                                <input type="text" class="form-control col-lg-2" id="point" name="point"/>
                            </div>
                        </div>
