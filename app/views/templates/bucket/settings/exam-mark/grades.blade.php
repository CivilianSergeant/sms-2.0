                    ...
                    <span class="tools pull-right">
                        <!--  <a class="fa fa-chevron-down" href="javascript:;"></a>
                         ...
                         {{ Form::open(array('url'=>'settings/grades/add','method'=>'get')) }}
                                <button class="btn btn-primary panel-btn" type="submit"><i class="fa fa-plus-circle"></i> Add Grade</button>
                         {{ Form::close() }}
                      </span>
                </header>
                                ...
                                @foreach($grades as $index => $grade)
                                    <tr class="gradeX">
                                        ...
                                        <td class="center hidden-phone">
                                            ...
                                            <a  href="{{{$grade->grade_id}}}" class="grid-action-link delete-grade-settings"><i class="fa fa-trash-o" title="Edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
