                    ...
                    Invoice No.  {{Request::segment(5)}}
                           <span class="tools pull-right">
                            <!--     <a href="javascript:;" class="fa fa-chevron-down"></a>
                                ...
                                {{ Form::open(array('url'=>'finance/report/teacher/'.Request::segment(5),'class'=>'col-lg-2','method'=>'get')) }}
                    ...
                    <div class="print-area row form-horizontal">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-lg-3 text-right">Teacher Name :</label>
                                <div class="col-lg-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <span>{{$teacher->name_initial}}</span>
                                </div>
                            </div>
                            <div class="form-group">
