        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    <?php $invoiceNumber = date('Ymd').'-T'.$teacher->id; ?>
                ...
                <div class="panel-body">
                    {{Form::Open(array('id'=>'stdTransactionFrm','url'=>'finance/invoice/teacher/'.$teacher->id,'method'=>'post'))}}
                    ...
                    <div class="print-area row form-horizontal">
                        <div class="col-lg-12">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <span>{{$teacher->name or ''}}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 text-right">Initial :</label>
                                    <div class="col-lg-7">
                                        <span>{{$teacher->name_initial or ''}}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-3 text-right">
                                ...
                                <input type="hidden" name="type" id="type" value="{{AccountTransaction::$TEACHER}}"/>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <table id="transaction_list" class="table">
                                ...
                                <tbody>
                                    <!--@if(count($transaction_template))
                                        @foreach($transaction_template as $tTemplate)
                                        <tr>
                                            <td>01</td>
                                            <td>
