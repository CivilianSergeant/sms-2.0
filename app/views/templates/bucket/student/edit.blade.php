            ...
            <section class="panel">
                ...
                {{Form::open(array('url'=>'student/update-student','method'=>'post','enctype'=>'multipart/form-data','id'=>'studentAddForm','class'=>'cmxform form-horizontal'))}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="student_id" name="student_id" type="text" value="{{{$student->student_id}}}" required/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="name" name="name" type="text" value="{{{$student->name}}}" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="nationality" class="control-label col-lg-3">Nationality <small>(Required)</small></label>
                            <div class="col-lg-6">
                                <input class=" form-control" id="nationality" name="nationality" type="text" value="{{{$student->nationality}}}" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dob" class="control-label col-lg-3">Date of Birth <small>(Required)</small></label>
                            <div class="col-lg-6">
                                <input class=" form-control" id="dob" name="dob" type="text" value="{{{Helpers::dateTimeFormat("j F,Y",$student->dob)}}}" required/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="father_name" name="father_name" type="text" value="{{{$student->father_name}}}" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="father_profession" name="father_profession"  type="text" value="{{{$student->father_profession}}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="father_cell_phone" name="father_cell_phone" type="text" value="{{{$student->father_cell_phone}}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="mother_name" name="mother_name" type="text" value="{{{$student->mother_name}}}" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="mother_profession" name="mother_profession" type="text" value="{{{$student->mother_profession}}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="mother_cell_phone" name="mother_cell_phone" type="text" value="{{{$student->mother_cell_phone}}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="no_of_child" name="no_of_child" type="text" value="{{{$student->no_of_child}}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="child_position" name="child_position" type="text" value="{{{$student->child_position}}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="no_of_sibling" name="no_of_sibling" type="text" value="{{{$student->no_of_sibling}}}" />
                            </div>
                        </div>
