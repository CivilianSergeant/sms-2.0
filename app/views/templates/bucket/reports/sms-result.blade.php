        ...
        <div class="col-sm-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form">
                        {{ Form::open(array('class'=>'cmxform form-horizontal','url'=>url('activities/'),'method'=>'post','id'=>'addSmsResultFrm')) }}
                        <div class="form-group">
                            ...
                            <label for="section_id" class="control-label col-lg-1">Term</label>
                            <div class="col-lg-3">
...
<script type="text/javascript" src="{{$theme}}js/custom/smsResult.js"></script>
@stop