 ...
 *  - Secure in MSIE 6+, but only when the user hasn't made custom to his security level "restricted"
...
(function(wysihtml5) {
  ...
  wysihtml5.quirks.getCorrectInnerHTML = function(element) {
    ...
    for (i=0, length=elementsWithTilde.length; i<length; i++) {
      ...
      urlToSearch = wysihtml5.lang.string(url).replace("_.html").by(TILDE_ESCAPED);
...
wysihtml5.views.View = Base.extend(
  ...
  wysihtml5.views.Composer = wysihtml5.views.View.extend(
    ...
    _initAutoLinking: function() {
      ...
      // If a user now custom the url in the innerHTML we want to make sure that
